...
- `AenderOrePlanner` deterministically places uncommon 2–5 block Aenderite veins across chunk borders. Candidate origins are biased into the lower 55% of an island column, and the generator replaces only Aender Stone after terrain formations and portal-frame deposits are complete.
